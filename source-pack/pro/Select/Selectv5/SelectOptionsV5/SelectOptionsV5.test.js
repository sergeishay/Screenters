...
const setup = (props = {}) => shallow(<SelectOptionsV5 {...expectedProps} {...props} />);
const mounted = (props = {}) => mount(<SelectOptionsV5 {...expectedProps} {...props} />);

describe('<SelectOptionsV5 />', () => {
  let wrapper;
  ...
  test('renders without errors', () => {
    ...
    ReactDOM.render(<SelectOptionsV5 {...expectedProps} />, div);
  });
  ...
  test('invoke changeFocus(value) onKeyDown for input', () => {
    checkCallBack(mounted({ search: true }), 'changeFocus', 'keydown', 'input', { keyCode: 27 });
  });

  test('invoke setFilteredOptions(value) onKeyDown for input', () => {
    checkCallBack(mounted({ search: true, changeFocus: () => {} }), 'setFilteredOptions', 'change', 'input', {
      keyCode: 27
    });
  });
